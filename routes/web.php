...
Route::middleware('auth')
    ...
    ->group(function(){
        ...
        Route::post('menus/{restaurant}', 'MenuController@newindex')->name('menus.newindex');
        Route::resource('menus', 'MenuController')->parameters(['menus' => 'menu:slug', 'restaurants' => 'restaurant:id']);
